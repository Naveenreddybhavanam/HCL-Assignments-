...
select * from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber;
+---------------+-------------------+------------------+----------------+-------------+---------------+-----------+
...
+---------------+-------------------+------------------+----------------+-------------+---------------+-----------+
5 rows in set (0.00 sec)
mysql> select * from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber where OpeningDate > '2020-09-28';
Empty set (0.16 sec)

mysql> select * from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber where OpeningDate > '2020-09-29';
Empty set (0.00 sec)
...
mysql> select * from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber where OpeningDate > '2020-08-29' order by CustomerNumber;
+---------------+-------------------+------------------+----------------+-------------+---------------+-----------+
| AccountNumber | CustomerFirstName | CustomerLastName | CustomerNumber | OpeningDate | AccountNumber | City      |
+---------------+-------------------+------------------+----------------+-------------+---------------+-----------+
|            10 | Naveen            | Reddy            |              1 | 2020-09-28  |            10 | chennai   |
