...
mysql> select CustomerFirstName from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber group by CustomerFirstName having Count(City) order by CustomerFirstName;
+-------------------+
| CustomerFirstName |
+-------------------+
| Naga              |
...
+-------------------+
4 rows in set (0.09 sec)
 select count(CustomerNumber) as Count_CustomerNumber from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber where CustomerNumber not in (select CustomerNumber from accounts);
+----------------------+
| Count_CustomerNumber |
+----------------------+
|                    0 |
...
+-------------------+
4 rows in set (0.00 sec)
mysql> select CustomerFirstName from customers inner join accounts on customers.AccountNumber = accounts.AccountNumber group by CustomerFirstName having Count(CustomerFirstName)>=2 order by CustomerFirstName;
+-------------------+
| CustomerFirstName |
+-------------------+
| Nani              |
